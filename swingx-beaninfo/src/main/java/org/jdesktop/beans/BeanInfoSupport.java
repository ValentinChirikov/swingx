 ...
 * and then you are given the opportunity to reconfigure portions of the bean
 * info in the <code>initialize</code> method.
 *
...
public abstract class BeanInfoSupport extends SimpleBeanInfo {
    ...
    /**
     * A reference to the icon. This String must be of a form that ImageIO can
     * use to locate and load the icon image
     */
    ...
    /**
     * attempts to load a png icon from the resource directory beneath beaninfo,
     * named like: JXTaskPaneContainer16.png JXTaskPaneContainer16-mono.png
     * JXTaskPaneContainer32.png JXTaskPaneContainer32-mono.png
     *
     * if any of the icons is missing, an attempt is made to get an icon via
     * introspection. If that fails, the icon will be set to placeholder16.png
    ...
    private Image loadStandardImage(BeanInfo info, int size) {
        ...
        Image image = null;
        try {
            image = loadImage("/org/jdesktop/swingx/resources/" + iconName);
        } catch (Exception e) {
            LOG.log(Level.INFO, "No icon named {0} was found", iconName);
        }
     ...
     * example, you could call setDisplayName("Foo Name", "foo") to change the
     * foo properties display name
     */
    ...
    protected void setDisplayName(String displayName, String propertyName) {
        ...
        if (pd != null) {
            ...
            LOG.log(Level.WARNING, "Failed to set display name for property ''{0}''. No such property was found", propertyName);
        }
    }
    ...
    protected void setTransient(boolean trans, String... propertyNames) {
        for (String propertyName : propertyNames) {
            ...
            if (pd != null) {
                ...
                LOG.log(Level.WARNING, "Failed to set transient attribute for property ''{0}''. No such property was found", propertyName);
            }
        }
    }
     ...
     *
     * @param hidden determines whether the properties should be marked as
     * hidden or not.
     * @param propertyNames name of properties.
     * @see PropertyDescriptor
     */
    protected void setHidden(boolean hidden, String... propertyNames) {
        for (String propertyName : propertyNames) {
            ...
            if (pd != null) {
                ...
                LOG.log(Level.WARNING, "Failed to set hidden attribute for property ''{0}''. No such property was found", propertyName);
            }
        }
    }
    ...
    protected void setExpert(boolean expert, String... propertyNames) {
        for (String propertyName : propertyNames) {
            ...
            if (pd != null) {
                ...
                LOG.log(Level.WARNING, "Failed to set expert attribute for property ''{0}''. No such property was found", propertyName);
            }
        }
    }
    ...
    protected void setPreferred(boolean preferred, String... propertyNames) {
        for (String propertyName : propertyNames) {
            ...
            if (pd != null) {
                ...
                LOG.log(Level.WARNING, "Failed to set preferred attribute for property ''{0}''. No such property was found", propertyName);
            }
        }
    }
    ...
    protected void setBound(boolean bound, String... propertyNames) {
        for (String propertyName : propertyNames) {
            ...
            if (pd != null) {
                ...
                LOG.log(Level.WARNING, "Failed to set bound attribute for property ''{0}''. No such property was found", propertyName);
            }
        }
    }
    ...
    protected void setConstrained(boolean constrained, String... propertyNames) {
        for (String propertyName : propertyNames) {
            ...
            if (pd != null) {
                ...
                LOG.log(Level.WARNING, "Failed to set constrained attribute for property ''{0}''. No such property was found", propertyName);
            }
        }
    }
    ...
    protected void setCategory(String categoryName, String... propertyNames) {
        for (String propertyName : propertyNames) {
            ...
            if (pd != null) {
                ...
                LOG.log(Level.WARNING, "Failed to set category for property ''{0}''. No such property was found", propertyName);
            }
        }
    }
    ...
    protected void setPropertyEditor(Class<?> editorClass, String... propertyNames) {
        for (String propertyName : propertyNames) {
            ...
            if (pd != null) {
                ...
                LOG.log(Level.WARNING, "Failed to set property editor for property ''{0}''. No such property was found", propertyName);
            }
        }
    }
    ...
    protected void setEnumerationValues(EnumerationValue[] values, String... propertyNames) {
        ...
        for (String propertyName : propertyNames) {
            ...
            if (pd != null) {
                ...
                LOG.log(Level.WARNING, "Failed to set enumeration values for property ''{0}''. No such property was found", propertyName);
            }
        }
    }
